# d:\programas\DDS\dds-webtools\bdo\services\boletim_service.py
...
from bdo.services.dataframe_utils import (
    resolver_base_ponto,
...
from bdo.services.comparacao import montar_triplet_comparacao, montar_tres_grids, map_boletim_por_data
from bdo.services.leitor_pdf import extrair_dados_pdf, parse_horas_funcionarios, extrair_var_dataset
from bdo.services.leitor_ponto import extrair_ponto_dataframe
...
class BoletimXPontoService:
    ...
    def parent_doc_ref(self):
        ...
        return db.collection("webtools").document("bdo")
