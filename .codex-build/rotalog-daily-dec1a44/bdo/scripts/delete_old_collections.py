# d:\programas\DDS\dds-webtools\bdo\scripts\delete_old_collections.py
import os
import sys
...
def main():
    ...
    old_collections = [
        "webtools_bdo_mappings",
        "webtools_bdo_boletins",
        "webtools_bdo_ponto",
        "webtools_bdo_vars",
        "webtools_bdo_contrato_boletim",
        "webtools_bdo"  # Metadata collection
    ]
