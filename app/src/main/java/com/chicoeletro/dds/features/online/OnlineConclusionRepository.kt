...
/**
 * Salva conclusão do DDS Online:
 * - Upload foto (e thumb opcional) no Firebase Storage
 * - Grava metadados no Firestore (subcoleção conclusions)
 */
class OnlineConclusionRepository(
