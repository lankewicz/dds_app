// Módulo: app/src/main/java/com/example/dds/features/viewer/ViewerViewModel.kt
// Caminho completo: [PROJECT_ROOT]/app/src/main/java/com/example/dds/features/viewer/ViewerViewModel.kt
// Descrição: ViewModel que carrega URLs de imagens de um treinamento em fluxo offline-primeiro:
//            1) Tenta no cache local (DataStore);
//            2) Se não presente, busca no Firebase Storage;
//            3) Salva no cache local;
//            4) Prefetch no Coil para uso off-line.
//
// Principais atualizações:
//   - 23/06/2025: Corrigida herança para AndroidViewModel e unificação de repository/context;
//   - 05/06/2025: Fluxo inicial: cache local → Storage → cache → prefetch Coil;
//   - 07/11/2025: OFFLINE-FIRST — carrega exclusivamente imagens locais em filesDir/trainings/<trainingId>
// Melhorias: IO dispatcher, tratamento de erros, sort natural, extensões centralizadas.
// Módulo: app/src/main/java/com/chicoeletro/dds/features/viewer/ViewerViewModel.kt
// Estratégia: OFFLINE-FIRST — carrega exclusivamente imagens locais em filesDir/trainings/<trainingId>
// Inclui: cancelamento de carregamentos, IO dispatcher, tratamento de erros, sort natural, extensões centralizadas.
...
class ViewerViewModel(
    ...
    private companion object {
        ...
        const val BLOCK_MESSAGE_TTL_MS = 3_000L
    }
