// Módulo: app/src/main/java/com/chicoeletro/dds/features/online/token/TokenModels.kt
// Função: Modelos de dados para requisição e resposta de tokens do servidor. Define o contrato 
//         de payloads para os serviços de RTC, RTM e Chat.
