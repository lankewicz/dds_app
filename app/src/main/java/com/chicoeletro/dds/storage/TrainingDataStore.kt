// Módulo: app/src/main/java/com/example/dds/storage/TrainingDataStore.kt
// Função: Gerencia o cache local de treinamentos usando DataStore Preferences.
// Histórico de Alterações:
//   - 03/06/2025: Criação inicial.
