...
// Descrição: Indexa os treinamentos já baixados no dispositivo (OFFLINE-FIRST).
//            Lê pastas em filesDir/trainings/<ID>, onde <ID> = "YYYY-MM-DD - Título",
//            e retorna uma lista de Training ordenada por data (mais recente primeiro).
// Estratégia: OFFLINE-FIRST — a UI consome apenas dados locais; atualização acontece no startup.
// Premissas: cada treinamento possui uma pasta própria; nomes seguem o padrão ISO + título.
// Saída: List<Training> com (id, date exibível "dd/MM/yyyy", title).
//
// Autor: Valdinei Lankewicz
// Última atualização: 07/11/2025
//
// Histórico de alterações:
//  - 07/11/2025: Ordenação por LocalDate; regex aceita '-' e '–'; cache leve por timestamp;
//                utilitários resolveFolder/exists/buildId/parseIdTriple; ocultos ignorados.
//  - 20/06/2025: Versão inicial.
