// Módulo: app/src/main/java/com/chicoeletro/dds/data/local/PendingDdsStore.kt
// Função: Persistência específica para submissões em fila (offline). Garante que formulários 
//         concluídos sem internet sejam preservados localmente para sincronização futura.
