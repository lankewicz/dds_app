// Módulo: app/src/main/java/com/chicoeletro/dds/data/ImageListStore.kt
// Função: Gerenciamento de cache local para imagens de treinamentos. Associa URLs remotas a 
//         caminhos de arquivos locais para possibilitar a visualização offline.
