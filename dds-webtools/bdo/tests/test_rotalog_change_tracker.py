...
class RotalogChangeTrackerTests(unittest.TestCase):
    ...
    def test_modo_json_nao_cria_batch_nem_operacoes_firestore(self):
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            with (
                mock.patch("bdo.services.rotalog_sync_task._ROTALOG_PERSISTENCE_MODE", "json"),
                mock.patch("bdo.services.rotalog_sync_task._local_cache", cache),
                mock.patch("bdo.services.rotalog_sync_task.get_firestore_client", return_value=DbSemEscrita()),
                mock.patch("bdo.services.rotalog_sync_task._hydrate_durable_cache_once"),
