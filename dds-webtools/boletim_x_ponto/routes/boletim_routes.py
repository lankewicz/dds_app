...
from boletim_x_ponto.services.pacote_veiculo_service import gerar_pacote_veiculo_zip
from boletim_x_ponto.services.rotalog_crawler_service import sincronizar_rotalog
