...
def compact_service(team_key: str, day: str, service: dict[str, typing.Any]) -> dict[str, typing.Any]:
    return {
        ...
        "geolocalizacao": service.get("geolocalizacao") or (
            {"latitude": service.get("latitude"), "longitude": service.get("longitude")}
            if service.get("latitude") is not None and service.get("longitude") is not None
            else None
        ),
    }
